...
public class FacultyWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public FacultyWorkAreaJPanel(Business b,Person p,FacultyProfile facProfile,  JPanel clp) {

        business = b;
        this.CardSequencePanel = clp;
        this.p = p;
        this.facProfile = facProfile;
        initComponents();
...
//        ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
    ...
    private void jButton6IdentifyEventsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6IdentifyEventsActionPerformed
        // TODO add your handling code here:
          AdminUserAccount ad = new AdminUserAccount(list, facProfile, CardSequencePanel);
...
//        CardSequencePanel.add("RiskAgendaObjectives", aos);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     private static void createAndShowGUI(Person p) {
        JFrame frame = new JFrame("Bar Chart Demo");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        DefaultCategoryDataset dataset = createDataset( p);
    ...
    private static DefaultCategoryDataset createDataset(Person p) {
        ...
        List<Integer> exm = p.getRatings(facultyName);
        double myRating = p.calculateAverageRating(facultyName);
        
        dataset.addValue(myRating, "Series 1", "Fall 22");
