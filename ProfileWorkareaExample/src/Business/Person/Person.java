...
public class Person {
  ...
  private static Map<String, List<Integer>> facultyRatings;
    ...
    public void addRating(String facultyName, int rating) {
    ...
    public double getRating(Person p){
        
         double rating = calculateAverageRating(p.getFirstName().toString());
         System.out.println("getRating ===>rating"+rating);
         System.out.println("getRating ===>facultyRatings"+facultyRatings);
         return rating;
    }
   ...
   public static double calculateAverageRating(String facultyName) {
        System.out.println("inside calculateAverageRating facultyRatings ==>"+facultyRatings);
    List<Integer> ratings = facultyRatings.get(facultyName);
    System.out.println("inside calculateAverageRating"+ratings);
    if (ratings == null || ratings.isEmpty()) {
         System.out.println("inside calculateAverageRating null");
        return 0.0; // Avoid division by zero
       
    } else {
          System.out.println("inside calculateAverageRating els");
        int sum = 0;
